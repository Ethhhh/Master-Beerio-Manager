...
EloChangeSecond1 = k_fact * (0 - second1)  # CHANGED: 1 -> 0 (Loss)
...
EloChangeSecond3 = k_fact * (1 - second3)  # CHANGED: 0 -> 1 (Win)
...
EloChangeThird1 = k_fact * (0 - third1)    # CHANGED: 1 -> 0 (Loss)
...
EloChangeThird3 = k_fact * (1 - third3)    # CHANGED: 0 -> 1 (Win)
...
EloChangeFourth1 = k_fact * (0 - fourth1)  # CHANGED: 1 -> 0 (Loss)
