#THIS ELO SIMULATOR USES THE ELO LOGIC FROM THE elocalculators\v3\elocalcv3.py calculator and does not consider any of the new logic!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
import random
import pandas as pd
...
TOTAL_RACES = 500 # the amount of races being simulated (4 random players selected from the player array and put against eachother)
